CREATE SCHEMA sohail;

CREATE TABLE sohail.[user](
...
CREATE TABLE sohail.skills(
    ...
    REFERENCES sohail.[user](user_id)

);



CREATE TABLE sohail.edu(
...
SELECT * From sohail.[user];
SELECT * From sohail.[skills];
SELECT * From sohail.[edu];
SELECT * From sohail.[comp];
