...
namespace UserProfile
{
    ...
    public class MyProfile
    {
        ...
        public void MyProfile1(int usid)
        {
            ...
            con.Open();
            string q = $"Select first_name,last_name,email_id,phone_no from sohail.[user] where user_id = {usid}";
        ...
        public void MyProfileEdu(int usid)
        {
            ...
            string q = $"Select * from sohail.edu where us_id = {usid}";
        ...
        public void MyProfileExperience(int usid)
        {
            ...
            string q = $"Select * from sohail.comp where us_id = {usid}";
            using SqlCommand cmd1 = new SqlCommand(q, conn);
            using SqlDataReader reader1 = cmd1.ExecuteReader();
            int countt = 1;
        ...
        public void MyProfileSkills(int usid)
        {
            ...
            string q = $"Select * from sohail.skills where us_id = {usid}";
            using SqlCommand cmd1 = new SqlCommand(q, conn);
            using SqlDataReader reader1 = cmd1.ExecuteReader();
            int countt = 1;
