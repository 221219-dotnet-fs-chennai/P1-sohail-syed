...
namespace UserProfile
{
    ...
    public class AddSkills
    {
        public void SkillAdder(int usid)
        {
            ...
            string skill_name = sq.SqlQueryWriterSkill($"Insert into sohail.skills(skill_name,skill_experience,us_id) Values('{SkillName}',{SkillExperience},{usid});");
            skill_name = sq.SqlQueryWriterSkill($"SELECT * from sohail.skills;");
    ...
    public class UpdateSkills
    {
        public void SkillUpdate(int usid)
        {
            ...
            DataTable reader = sq.SqlQeryWriterSkillUpdate($"select k.skill_id,k.skill_name,k.skill_experience from sohail.Skills as k WHERE k.us_id = {usid};");
            ...
            sq.sqlQueryDelete($"UPDATE sohail.skills SET skill_name = '{resname}', skill_experience = {resex} WHERE skill_id = {res};");
    ...
    public class DeleteSkill
    {
        public void SkillDelete(int usid)
        {
            ...
            sq.sqlQueryDelete($"DELETE FROM sohail.skills WHERE skill_id ={skill_id}");
